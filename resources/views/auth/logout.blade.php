...
<html>
    <head>
        ...
        <!-- App title -->
        <title>SIPAMA - Sistem Informasi Pengelolaan Surat Masuk</title>
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    <div class="text-center m-b-20">
                                        ...
                                        <p class="text-muted font-13 m-t-10"> Silahkan Kembali Ke Menu Login Untuk Masuk Kembali kedalam Sistem</p>
                                    </div>
                            ...
                            <div class="row m-t-30">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Kembali ke <a href="{{ url('/') }}" class="text-primary m-l-5 m-r-5"><b>Log In</b></a></p>
                                </div>
                            </div>
